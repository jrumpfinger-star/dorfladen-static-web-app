...
<header class="k-header">
  ...
  <div class="k-header-acts">
    <button class="k-hbtn k-head-extra" id="k-kunden-btn" onclick="K.switchTab('kunden')" title="Stammkunden verwalten" aria-label="Stammkunden verwalten"><i data-lucide="users"></i></button>
    <a class="k-hbtn k-head-extra" href="/index.html" title="Zur Website" aria-label="Zur Website"><i data-lucide="house"></i></a>
    <a class="k-hbtn k-head-extra" href="/cms.html" title="Zum CMS" aria-label="Zum CMS"><i data-lucide="settings"></i></a>
    ...
    <!-- Auf dem Telefon passen Titel und sechs Symbole nicht in eine Zeile.
         Die drei selteneren stehen dann hier drin; ab 560 px ist dieser
         Knopf ausgeblendet und alle sechs stehen wieder direkt da.
         (Spec kiosk-bestellreiter-mobil, F2) -->
    <button class="k-hbtn k-head-mehr" onclick="K.kopfMenue()" title="Weitere Bereiche" aria-label="Weitere Bereiche" aria-expanded="false"><i data-lucide="more-horizontal"></i></button>
  </div>
</header>
