...
- Name: tests\frontend.spec.js >> Dorfladen Oberornau Frontend >> Preisliste zeigt Daten
- Location: tests\frontend.spec.js:7:3
...
Locator: locator('#preisliste-live')
Timeout: 5000ms
- Expected  - 4
+ Received  + 1
...
Call log:
  ...
  - waiting for locator('#preisliste-live')
