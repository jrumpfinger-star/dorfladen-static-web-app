...
- Name: meine-bestellungen.spec.js >> T-MB-01 Unified Order View – DOM-Struktur (AK-MB-01, AK-MB-06) >> T-MB-01-03 _myOrdersFilter Default ist open
- Location: tests\meine-bestellungen.spec.js:21:3

# Error details

```
Error: page.evaluate: ReferenceError: _myOrdersFilter is not defined
