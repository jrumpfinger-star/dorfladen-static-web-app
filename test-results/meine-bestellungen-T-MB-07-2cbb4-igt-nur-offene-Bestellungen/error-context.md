...
- Name: meine-bestellungen.spec.js >> T-MB-07 Filter-Logik (AK-MB-07, AK-MB-08, AK-MB-09, AK-MB-10) >> T-MB-07-01 Filter open zeigt nur offene Bestellungen
- Location: tests\meine-bestellungen.spec.js:66:3

# Error details

```
Error: page.evaluate: ReferenceError: renderMyOrders is not defined
    at eval (eval at evaluate (:302:30), <anonymous>:41:7)
