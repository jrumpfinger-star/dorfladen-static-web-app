"""
Create Dataverse fields dl_kunde_kommentar and dl_personal_antwort
on the dl_mittagsbestellungs entity.

Usage:
  python scripts/create-dv-fields.py
"""
import os
import sys
import json
...
ENTITY_LOGICAL_NAME = "dl_mittagsbestellung"
...
FIELDS = [
    ...
    {
        "SchemaName": "dl_personal_antwort",
        "DisplayName": {"@odata.type": "Microsoft.Dynamics.CRM.Label", "LocalizedLabels": [{"@odata.type": "Microsoft.Dynamics.CRM.LocalizedLabel", "Label": "Personal Antwort", "LanguageCode": 1031}]},
        "Description": {"@odata.type": "Microsoft.Dynamics.CRM.Label", "LocalizedLabels": [{"@odata.type": "Microsoft.Dynamics.CRM.LocalizedLabel", "Label": "Antwort des Personals auf Kundenkommentar", "LanguageCode": 1031}]},
        "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
        "AttributeType": "String",
        "FormatName": {"Value": "Text"},
        "MaxLength": 2000,
