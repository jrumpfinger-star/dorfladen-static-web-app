...
- [ ] **T001** Playwright-Testdatei `tests/dark-mode-setting.spec.js` anlegen
...
- [ ] **T010** In [static-site/js/theme.js](../../static-site/js/theme.js) die
...
- [ ] **T011** theme.js: Pre-Paint aus `localStorage['dl-dark-allowed']` (fehlt →
...
- [ ] **T012** theme.js: Floating-Button-Injektion `#dl-theme-toggle` und die
...
- [ ] **T020** [P] Playwright F1: CMS lädt Schalter aus `feature_flags`,
  Speichern sendet korrekten POST-Body (Netzwerk-Assert), übrige Flags
  erhalten. — covers `TC-F1-01`, `TC-F1-02`, `TC-F1-03`
- [ ] **T021** [P] Playwright F2: `dark_mode=false` erzwingt `light` (trotz
...
- [ ] **T022** [P] Playwright F3: kein `#dl-theme-toggle`; `emulateMedia`-Wechsel
  → live dunkel bei erlaubt, bleibt hell bei nicht erlaubt. — covers
  `TC-F3-01`, `TC-F3-02`, `TC-F3-03`
- [ ] **T023** [P] Playwright F4: Cache `'1'` → erster Frame dunkel;
...
- [ ] **T030** Gesamte Spec `tests/dark-mode-setting.spec.js` über alle 3
