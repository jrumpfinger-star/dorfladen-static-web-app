...
CMS_USERNAME = os.environ.get("CMS_USERNAME", "cms")
CMS_PASSWORD = os.environ.get("CMS_PASSWORD", "DorfladenCMS!")
CMS_SECRET_KEY = os.environ.get("CMS_SECRET_KEY", "cms-secret-key-2026")
