...
window.dlConfirm=function(opts,onConfirm){
  ...
  ov.innerHTML='<div style="background:#fff;border-radius:16px;max-width:360px;width:100%;padding:24px;box-shadow:0 16px 48px rgba(0,0,0,.2);animation:dlcSlideUp .2s ease">'
    ...
    +'<div style="text-align:center;font-size:17px;font-weight:800;color:#1f2937;margin-bottom:6px">'+esc(title)+'</div>'
    +(msg?'<div style="text-align:center;font-size:14px;color:#6b7280;line-height:1.5;margin-bottom:20px">'+esc(msg)+'</div>':'<div style="margin-bottom:20px"></div>')
    +'<div style="display:flex;gap:10px">'
    +'<button id="dl-confirm-cancel" style="flex:1;padding:12px 16px;border:none;border-radius:12px;font-size:15px;font-weight:700;cursor:pointer;background:#f3f4f6;color:#6b7280;transition:background .15s">'+esc(cancelText)+'</button>'
    +'<button id="dl-confirm-ok" style="flex:1;padding:12px 16px;border:none;border-radius:12px;font-size:15px;font-weight:700;cursor:pointer;color:#fff;background:'+color+';transition:background .15s">'+esc(okText)+'</button>'
    +'</div></div>';
