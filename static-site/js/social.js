...
(function(){
  ...
  window.socialPickUpdate=function(justToggled){
    ...
    if(justToggled&&justToggled.checked&&sel.length>MAX){
      ...
      if(cnt){var _old=cnt.textContent,_c=cnt.style.color;cnt.textContent='Maximal '+MAX+' Produkte pro Post';cnt.style.color='#dc2626';cnt.style.fontWeight='600';setTimeout(function(){cnt.textContent=_old;cnt.style.color=_c;cnt.style.fontWeight='';},2600);}
    }
