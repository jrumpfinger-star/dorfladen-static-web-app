  ...
  function socialRenderKatalog(){
    ...
    Object.keys(cats).forEach(function(cat){
      ...
      cats[cat].forEach(function(p,i){
        ...
        html+='<div class="k-field" style="margin-bottom:0"><label>Preis &euro;</label><input id="soc-ed-preis-'+pid+'" type="number" step="0.01" min="0" value="'+(edP&&isFinite(edP)?edP.toFixed(2):(p.preis||''))+'"></div>';
        html+='</div>';
