  ...
  function socialRenderKatalog(){
    ...
    Object.keys(cats).forEach(function(cat){
      ...
      cats[cat].forEach(function(p,i){
        ...
        html+='<div style="flex:2;min-width:140px"><label style="font-size:11px;font-weight:700;color:#6b7280;display:block;margin-bottom:3px">Name</label><input id="soc-ed-name-'+pid+'" style="width:100%;font-size:14px;padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;box-sizing:border-box;min-height:40px" value="'+esc(p.name)+'"></div>';
        html+='<div style="flex:1;min-width:100px"><label style="font-size:11px;font-weight:700;color:#6b7280;display:block;margin-bottom:3px">Kategorie</label><select id="soc-ed-kat-'+pid+'" style="width:100%;font-size:14px;padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;box-sizing:border-box;min-height:40px">';
        html+=socKatOptionsHtml(p.kategorie);
        html+='</select></div>';
        var edP=parseFloat(p.preis);
        html+='<div style="width:80px"><label style="font-size:11px;font-weight:700;color:#6b7280;display:block;margin-bottom:3px">Preis &euro;</label><input id="soc-ed-preis-'+pid+'" type="number" step="0.01" min="0" style="width:100%;font-size:14px;padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;box-sizing:border-box;min-height:40px" value="'+(edP&&isFinite(edP)?edP.toFixed(2):(p.preis||''))+'"></div>';
        html+='<div style="display:flex;gap:6px;align-items:center;flex-wrap:wrap;margin-top:4px"><button class="k-btn k-btn-confirm" onclick="socialKatSave(\''+pid+'\')" style="padding:8px 14px;font-size:13px;min-height:40px">'+lucideIcon('check',14)+' Speichern</button>';
        html+='<button class="k-btn k-btn-outline" onclick="socialKatCancelEdit(\''+pid+'\')" style="padding:8px 12px;font-size:13px;min-height:40px">Abbrechen</button></div>';
        html+='</div>';
