...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      '.kal-week{font-weight:600;font-size:15px;min-width:150px;color:var(--kt)}.kal-week small{display:block;font-weight:400;color:var(--km);font-size:12px}',
      '.kal-today{margin-left:auto;padding:9px 16px;border:1.5px solid var(--kp);background:var(--ks);color:var(--kp);border-radius:12px;font-weight:600;font-size:13px;cursor:pointer}',
      ...
      '.kal-day .dow{display:block;font-size:11px;font-weight:600;text-transform:uppercase}.kal-day .dnum{display:block;font-size:20px;font-weight:600;line-height:1.1}',
      ...
      '.kal-new{margin-left:8px;padding:9px 16px;border:none;background:var(--kp);color:#fff;border-radius:12px;font-weight:600;font-size:13px;cursor:pointer;white-space:nowrap;min-height:44px;display:inline-flex;align-items:center;justify-content:center}',
      '.kal-toggle{display:inline-flex;border:1.5px solid var(--kb);border-radius:12px;overflow:hidden}',
      '.kal-toggle button{border:none;background:var(--ks);padding:9px 14px;font-size:13px;font-weight:600;cursor:pointer;color:var(--km)}.kal-toggle button.on{background:var(--kp);color:#fff}',
      '.kal-add{background:var(--kp);color:#fff;border:none;border-radius:12px;padding:10px 20px;font-weight:600;font-size:14px;cursor:pointer;min-height:44px;display:inline-flex;align-items:center;justify-content:center}',
      ...
      '.kal-confirm-head{font-size:18px;font-weight:600;color:var(--kp);margin-bottom:10px}',
      ...
      '.kal-confirm-btn{min-height:52px;padding:12px 18px;border-radius:12px;border:1px solid var(--kb);font-size:16px;font-weight:600;cursor:pointer;width:100%;background:var(--ks);color:var(--kt)}',
      ...
      '.kal-modal-head{display:flex;align-items:center;justify-content:space-between;font-size:17px;font-weight:600;color:var(--kp);margin-bottom:12px}',
      ...
      '.kal-fld{display:block;margin-bottom:12px}.kal-fld>span{display:block;font-size:12px;font-weight:600;color:var(--km);margin-bottom:5px}',
      ...
      '.kal-tp-btn{width:52px;height:44px;border:1.5px solid var(--kb);border-radius:12px;background:var(--ks);color:var(--kt);font-size:24px;font-weight:600;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center;-webkit-user-select:none;user-select:none}',
      '.kal-tp-btn:active{background:var(--kp);color:#fff;border-color:var(--kp)}',
      '.kal-tp-lbl{font-size:11px;font-weight:600;color:var(--km);text-transform:uppercase;letter-spacing:.5px}',
      '.kal-tp-face{display:flex;align-items:center;gap:6px}',
      '.kal-timebox .kal-tp-face .kal-time-txt{width:96px;flex:0 0 auto;height:56px;border:1.5px solid var(--kb);border-radius:12px;padding:0 8px;font-size:24px;font-weight:600;text-align:center;letter-spacing:1px;font-variant-numeric:tabular-nums;background:var(--ks);color:var(--kt);font-family:inherit;box-sizing:border-box}',
      '.kal-time-txt:focus{outline:none;border-color:var(--kp)}',
      '.kal-time-uhr{font-size:13px;font-weight:600;color:var(--km)}',
      '.kal-tp-quick{display:flex;flex-wrap:wrap;gap:8px;justify-content:center}',
      '.kal-tp-q{min-width:56px;min-height:44px;padding:0 12px;border:1.5px solid var(--kb);border-radius:999px;background:var(--ks);color:var(--kt);font-size:15px;font-weight:600;font-variant-numeric:tabular-nums;cursor:pointer}',
      ...
      '.kal-btn-ghost{padding:10px 16px;border:1.5px solid var(--kb);background:transparent;color:var(--kt);border-radius:12px;font-weight:600;font-size:14px;cursor:pointer;min-height:44px;display:inline-flex;align-items:center;justify-content:center}',
      '.kal-pills{display:flex;flex-wrap:wrap;gap:6px}',
      '.kal-pill{padding:8px 12px;border:1.5px solid var(--kb);border-radius:20px;background:var(--ks);font-size:13px;font-weight:600;cursor:pointer;color:var(--kt);display:inline-flex;align-items:center;gap:6px}',
      ...
      '.kal-wd{width:42px;padding:8px 0;border:1.5px solid var(--kb);border-radius:10px;background:var(--ks);font-weight:600;font-size:13px;cursor:pointer;color:var(--kt);text-align:center}',
      ...
      '.kal-sec{font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.6px;color:var(--km);margin:16px 2px 8px}.kal-sec span{background:var(--kb);border-radius:20px;padding:1px 9px;font-size:11px}',
      '.kal-dayhead{font-size:16px;font-weight:600;color:var(--kp);margin:2px 2px 10px;text-transform:capitalize}',
      '.kal-datum{font-size:12px;font-weight:600;color:var(--km);margin-right:2px;white-space:nowrap}',
      ...
      '.kal-entry .time{font-weight:600;font-size:15px;color:var(--kp)}.kal-entry .time.allday{color:var(--km);font-size:12px;font-weight:600;text-transform:uppercase}',
      '.kal-entry .title{font-weight:600;font-size:15px;flex:1 1 100%;min-width:0;color:var(--kt);white-space:pre-wrap;overflow-wrap:break-word;word-break:normal;line-height:1.35}',
      '.kal-entry .top>.title{width:100%}',
      '.kal-entry .badges{display:flex;gap:5px;flex-wrap:wrap;margin-top:4px}',
      '.kal-entry .badge{font-size:11px;font-weight:600;padding:2px 8px;border-radius:20px}',
      ...
      '.kal-tl-time{width:50px;flex-shrink:0;text-align:right;font-weight:600;font-size:14px;color:var(--kp);padding-top:12px;font-variant-numeric:tabular-nums;line-height:1.1}',
