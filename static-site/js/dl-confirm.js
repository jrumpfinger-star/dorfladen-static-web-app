...
(function(){
  ...
  if(!document.getElementById('dl-confirm-style')){
    ...
    sty.textContent=[
      ...
      '.dlc-title{text-align:center;font-size:18px;font-weight:600;color:var(--dlc-title,#1f2937);margin-bottom:6px}',
      ...
      '.dlc-btn{flex:1;padding:12px 16px;border:none;border-radius:12px;font-size:15px;font-weight:600;cursor:pointer;transition:background .15s}',
