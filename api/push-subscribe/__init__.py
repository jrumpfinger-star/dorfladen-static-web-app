...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if r.status_code in (200, 201, 204):
        # Validate endpoint by sending a silent test push
        try:
            ...
            if vapid_priv:
                ...
                claims = {"sub": vapid_contact, "aud": aud}
                webpush(
                    subscription_info=subscription,
                    data=json.dumps({"title": "Dorfladen Oberornau", "body": "Push-Benachrichtigungen aktiviert! \u2705", "url": "/"}),
            ...
            if st in (404, 410):
                # Endpoint is dead – delete from Dataverse and tell frontend
                ...
                return func.HttpResponse(
                    json.dumps({"success": False, "endpoint_invalid": True, "error": f"Push endpoint rejected ({st})"}),
                    status_code=200, mimetype="application/json", headers=get_cors_headers()
                )
